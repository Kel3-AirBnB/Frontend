    ...
    <header className="bg-white border-b py-4">
      <div className="container mx-auto flex justify-between gap-6 items-center px-4">
        ...
        <div className="relative w-full max-w-xl mx-auto bg-white rounded-full">
          <input placeholder="e.g. Bali resort" className="rounded-full w-full h-14 bg-transparent py-2 pl-8 pr-32 outline-none border-2 border-gray-100 shadow-md hover:outline-none focus:ring-teal-200 focus:border-teal-200" type="text" />
          <button
            type="submit"
